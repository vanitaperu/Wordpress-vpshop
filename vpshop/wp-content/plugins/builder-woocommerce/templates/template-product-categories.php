...
$container_class = apply_filters('themify_builder_module_classes', array(
	'module','woocommerce', 'module-' . $mod_name, $element_id, $fields_args['css_products'], 'shows_' . $fields_args['display']
...
<div <?php echo self::get_element_attributes(self::sticky_element_props($container_props,$fields_args)); ?>>
	<?php 
		$container_props=$container_class=$query_args=null;
		...
		if (!empty($product_categories)):
			...
			$class=apply_filters('themify_loops_wrapper_class', $class, 'product', $layout, 'builder', $fields_args, $mod_name);
			$class[]='tf_clear';
			...
			<ul class="<?php echo implode(' ',$class)?>">
				...
				foreach ( $product_categories as $category ) : ?>
					<li class="product-category product">
						...
						TB_Product_Categories_Module::get_category_image($category);
                        ...
                        <?php if ('yes' === $fields_args['cat_desc'] && $category->description !== ''): ?>
                            <div><?php esc_attr_e($category->description); ?></div>
                        <?php endif ?>
					</li>
					<?php
				endforeach;
