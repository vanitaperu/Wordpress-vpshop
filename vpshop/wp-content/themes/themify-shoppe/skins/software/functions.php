<?php
/**
 * Custom functions specific to the Software skin
 *
 * @package Themify Shoppe
 */

/**
 * Load Google web fonts required for the Software skin
 *
 * @since 1.4.9
 * @return array
 */
...
add_filter( 'themify_google_fonts', 'themify_theme_software_google_fonts' );