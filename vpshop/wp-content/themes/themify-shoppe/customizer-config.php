...
function themify_theme_customizer_definition( $args ) {
	...
	$args = array(
		...
		'sticky_header_link_font' => array(
			...
			'selector' => '#headerwrap.fixed-header #site-logo a, #headerwrap.fixed-header .icon-menu li > a, #headerwrap.fixed-header #main-nav > li > a, #headerwrap.fixed-header #menu-icon, #headerwrap.fixed-header .icon-menu',
			'prop' => 'font',
		),
		...
		'sticky_header_link_color' => array(
			...
			'selector' => 'body:not(.mobile_menu_active) #headerwrap.fixed-header #header a, .mobile_menu_active #headerwrap.fixed-header #site-logo a, .mobile_menu_active #headerwrap.fixed-header #menu-icon, #headerwrap.fixed-header .icon-menu',
			'prop' => 'color',
		),
		...
		'sticky_header_link_hover_color' => array(
			...
			'selector' => 'body:not(.mobile_menu_active) #headerwrap.fixed-header #header a:hover, .mobile_menu_active #headerwrap.fixed-header #site-logo a:hover, .mobile_menu_active #headerwrap.fixed-header #menu-icon:hover, #headerwrap.fixed-header .icon-menu:hover',
			'prop' => 'color',
		),
